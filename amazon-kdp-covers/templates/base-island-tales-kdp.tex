...
% With old spine, set \providecommand{\centralbarwidth}{8.6cm}
...
% Define an option to use the old spine image
\providecommand{\useOldSpine}{}

\newcommand{\OldSpine}[2]{%
  \edef\tempcheck{#1}%
  \ifx\tempcheck\empty
    % Use text for spine
  ...
  \else
    \node at (current page.center) {
        \includegraphics{images/island_tales_resized_cropped_spine.png}
    };
